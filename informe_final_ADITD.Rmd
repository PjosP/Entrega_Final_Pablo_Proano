...
vars_entrada <- c(
  "TIPO_IMPORTACION", "REGIMEN", "SUBPARTIDA", "PAIS_ORIGEN",
  "TRATAMIENTO_PREFERENCIAL", "CONVENIO_INTERNACIONAL",
...
vars_salida <- c(
  ...
  "FODINFA", "SALVAGUARDIA", "IVA"
)

# Unir las variables seleccionadas
